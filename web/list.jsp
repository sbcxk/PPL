    ...
    <div style="float: left">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="${condition.name[0]}" id="exampleInputName2" name="name">
            </div>
            <div class="form-group">
                <label for="exampleInputName3">籍贯</label>
                <input type="text" class="form-control" value="${condition.address[0]}" id="exampleInputName3" name="address">
            </div>
            <div class="form-group">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                 ...
                 <c:if test="${pb.currentPage>pb.totalPage-2}">
                    <li class="disabled">
                  </c:if>
